...
/**
 * Real "My Performance" — current pipeline snapshot (in-flight jobs) plus
 * historical stats (completed count, QC/Team-Lead rejection rate, avg
 * turnaround) from the analytics performance rollup
 * (ChangeArt-New-PRD.md §5.4/§5.5).
 */
  ...
  return (
    <div className="page">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 mt-3">
        ...
        <Panel title="Jobs by Order Type" className="lg:col-span-2">
          {byOrderType.length === 0 ? (
            <div className="text-[12px] text-text-faint italic">No jobs in flight.</div>
          ) : (
